...
static inline int tdx_skip_emulated_instruction(struct kvm_vcpu *vcpu) { return -EOPNOTSUPP; }
static inline void tdx_set_interrupt_shadow(struct kvm_vcpu *vcpu, int mask) {}

static inline int tdx_vcpu_ioctl(struct kvm_vcpu *vcpu, void __user *argp) { return -EOPNOTSUPP; }
static inline int tdx_update_coco_vm(struct kvm *kvm, struct kvm_coco *update)
{
	return -EOPNOTSUPP;
}
static inline int tdx_update_coco_vcpu(struct kvm_vcpu *vcpu, struct kvm_coco *update)
{
	return -EOPNOTSUPP;
}
