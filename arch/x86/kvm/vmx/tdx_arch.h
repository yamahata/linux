 ...
 */
#define MD_FIELD_ID_WBINVD_DOMAINS_NUM		0x8000000100000040ULL
#define MD_FIELD_ID_WBINVD_DOMAIN_IDS		0x8000000300000080ULL
#define MD_FIELD_ID_WBINVD_DOMAIN_MASKS		0x8000000300000100ULL
#define MD_FIELD_ID_CURR_WBINVD_DOMAIN_ID	0x8000000300000180ULL
#define MD_FIELD_ID_CURR_WBINVD_DOMAIN_MASK	0x8000000300000200ULL
...
#define MD_FIELD_ID_FEATURES0_WBINVD_DOMAINS	BIT_ULL(15)
