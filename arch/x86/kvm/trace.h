...
#define kvm_trace_symbol_tdvmcall				\
	...
	TDG_VP_VMCALL_NAME(TDVMCALL_GET_TD_VM_CALL_INFO),	\
	TDG_VP_VMCALL_NAME(TDVMCALL_MAP_GPA),			\
	TDG_VP_VMCALL_NAME(TDVMCALL_GET_QUOTE),			\
	TDG_VP_VMCALL_NAME(TDVMCALL_REPORT_FATAL_ERROR),	\
	TDG_VP_VMCALL_NAME(TDVMCALL_SETUP_EVENT_NOTIFY_INTERRUPT)
