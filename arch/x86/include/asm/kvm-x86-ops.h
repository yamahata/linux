...
KVM_X86_OP_OPTIONAL(mem_enc_read_memory)
KVM_X86_OP_OPTIONAL(mem_enc_write_memory)
KVM_X86_OP_OPTIONAL(guest_memory_reclaimed)
KVM_X86_OP_OPTIONAL(update_protected_vm)
KVM_X86_OP_OPTIONAL(update_protected_vcpu)
