...
#define PFERR_LEVEL_SHIFT	50
#define PFERR_LEVEL_MASK	GENMASK_ULL(PFERR_LEVEL_SHIFT + 3, PFERR_LEVEL_SHIFT)
#define PFERR_LEVEL(err_code)	(((err_code) & PFERR_LEVEL_MASK) >> PFERR_LEVEL_SHIFT)
#define PFERR_LEVEL_ERR_CODE(pg_level)	\
	((((u64)(pg_level)) << PFERR_LEVEL_SHIFT) & PFERR_LEVEL_MASK)
...
struct kvm_x86_ops {
	...
	int (*update_protected_vm)(struct kvm *kvm, struct kvm_update_protected *update);
	int (*update_protected_vcpu)(struct kvm_vcpu *vcpu, struct kvm_update_protected *update);
